...
export default function RegisterPage() {
  ...
  const handleGoogleSignUp = async () => {
    try {
      console.log("Starting Google signup, redirect URL:", `${window.location.origin}/auth/callback`)
      const supabase = getSupabaseClient()
      ...
      console.log("Google signup initiated, data:", data)
    } catch (error: any) {
            ...
            <Card className="border-2 border-blue-100 shadow-lg">
              ...
              <CardContent className="space-y-4">
                ...
                <div className="grid grid-cols-1 gap-4">
                  <Button variant="outline" className="border-blue-200 hover:bg-blue-50" onClick={handleGoogleSignUp}>
