...
export default function LoginPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Redirection vers la page demandée ou pricing par défaut
      router.push(redirectPath)
      router.refresh()
    } catch (error: any) {
      console.error("Login error:", error)
      
      // Vérifier si l'erreur est "Invalid login credentials"
  ...
  const handleGoogleLogin = async () => {
    try {
      ...
      console.error("=== GOOGLE LOGIN START ===")
  ...
  const handleMagicLinkLogin = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const { error } = await supabase.auth.signInWithOtp({
        ...
        options: {
          shouldCreateUser: true, // Crée un utilisateur si l'email n'existe pas
      ...
      setMagicLinkSuccess("Check your email for the magic link to log in!")
      setMagicLinkEmail("") // Clear the input after sending
    } catch (error: any) {
      console.error("Magic link login error:", error)
      setMagicLinkSuccess(null) // Clear success message on error
      toast({
        variant: "destructive",
            ...
            <Card className="border-2 border-blue-100 shadow-lg">
              ...
              <CardContent className="space-y-4">
                <form onSubmit={handleSubmit} className="space-y-4">
                  ...
                  {/* Message d'erreur pour les identifiants invalides */}
                  {loginError && (
                ...
                <div className="grid grid-cols-1 gap-4">
                  <Button variant="outline" className="border-blue-200 hover:bg-blue-50" onClick={handleGoogleLogin}>
                ...
                <form onSubmit={handleMagicLinkLogin} className="space-y-4 mt-4">
                  ...
                  <Button type="submit" className="w-full bg-purple-600 hover:bg-purple-700" disabled={isMagicLinkLoading}>
